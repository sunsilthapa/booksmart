package  com.example.bookmarts.config;
import com.example.bookmarts.repository.UserRepository;
import com.example.bookmarts.service.impl.UserDetailsServiceImpl;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests()
                .antMatchers("/","/home","/index","/about","/help","/register","/list","/payment","/cart/**").permitAll()
